...
namespace DineAByte\SumUp\Payments;
...
class SumUp extends BasePaymentGateway
{
    ...
    protected string $sessionKey = 'ti_dineabyte_sumup_intent';
    ...
    public function isApplicable($total, $host): bool
    {
    ...
    {
        $controller->addCss('$/dineabyte/sumup/assets/sumup.css', 'sumup-css');
        $controller->addJs('$/dineabyte/sumup/assets/process.sumup.js', 'process-sumup-js');
    }
    ...
    protected function createGateway()
    {
        try {
            $sumup = new \SumUp\SumUp([
                'access_token'     => 'sup_sk_fEbKUus8qkPtTK2RUbStCWfMKnUzYEVOi',
            ]);
            $checkoutService = $sumup->getCheckoutService();
            $checkoutResponse = $checkoutService->create(10, 'EUR', 'uniqid', 'david@dineabyte.de');
